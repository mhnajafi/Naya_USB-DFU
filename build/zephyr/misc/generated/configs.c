...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_OFFSET, 0xf4000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x0005);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_REQUEST_BUFFER_SIZE, 2048);
